                ...
                'rules' => [
                    ...
                    [
                        'actions' => [
                            ...
                            'excel-export', 'generate-bar-code-for-weight', 'generate-bar-code-for-piece', 'export-bar-code-pdf'
                        ],
                        'allow' => true,
                        'roles' => ['Drektor'],
                        'matchCallback' => function () {
                            $controllers = ['statistics', 'site', 'suppliers', 'warehouses', 'products', 'list-of-transitions', 'product-types', 'transition-list-group'];

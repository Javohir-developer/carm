...
<div class="transition-list-group-form">
    ...
    <?= $form->field($model, 'product_types_id')->textInput() ?>
    ...
    <?= $form->field($model, 'size_num')->textInput() ?>
    ...
    <?= $form->field($model, 'code_group')->textInput() ?>
